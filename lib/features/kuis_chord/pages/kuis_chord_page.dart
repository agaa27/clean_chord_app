...
import 'kuis_chord_game_page.dart';

class KuisChordPage extends StatelessWidget {
  const KuisChordPage({super.key});
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: const Row(
        children: [
          Icon(Icons.quiz_rounded, color: Color(0xFF00E5FF), size: 20),
          SizedBox(width: 8),
          Text(
            'Kuis Chord',
            style: TextStyle(
  ...
  Widget build(BuildContext context) {
    final Map<String, List<QuizLevel>> grouped = {
      'Pemula':   quizLevels.where((l) => l.difficulty == 'Pemula').toList(),
      'Menengah': quizLevels.where((l) => l.difficulty == 'Menengah').toList(),
      'Mahir':    quizLevels.where((l) => l.difficulty == 'Mahir').toList(),
    };
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.music_note_rounded, color: _cyan, size: 18),
                    ),
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 2),
                          Text(
                            'Tebak chord dari diagram fretboard',
                  ...
                  children: [
                    ...
                    ...levels.map((level) {
                      final status = ProgressionService.instance.levelStatus(
                        ProgressionConfig.featureQuiz, level.id,
                      );
                      return _LevelCard(
                        level: level,
                        accentColor: color,
          ...
          child: InkWell(
            ...
            onTap: isLocked
                ...
                : () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => KuisChordGamePage(level: level),
                      ),
                    ),
            child: Container(
